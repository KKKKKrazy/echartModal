	...
	g.prototype = {
		...
		_end: function(o) {
			...
			if(this.options.momentum && n < 300) {
				k = this.hasHorizontalScroll ? c.momentum(this.x, this.startX, n, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0) : {
					destination: i,
					duration: 0
				};
				j = this.hasVerticalScroll ? c.momentum(this.y, this.startY, n, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0) : {
					destination: t,
					duration: 0
				};
				i = k.destination;
		...
		_initIndicators: function() {
			var l = this.options.interactiveScrollbars,
				o = typeof this.options.scrollbars != "object",
			...
			if(this.options.indicators) {
				q = q.concat(this.options.indicators)
			}
			for(var m = q.length; m--;) {
				this.indicators.push(new b(this, q[m]))
			}

			function j(s) {
				for(var r = p.indicators.length; r--;) {
					s.call(p.indicators[r])
				}
			}
